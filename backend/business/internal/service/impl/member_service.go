...
func (s *MemberServiceImpl) UpdateBusinessName(ctx context.Context, businessID int, name string) error {
...
func (s *MemberServiceImpl) UpdateBusinessIcon(ctx context.Context, businessID int, icon []byte) error {
	if len(icon) == 0 {
...
func (s *MemberServiceImpl) AnonymizeMember(ctx context.Context, businessID int) error {
