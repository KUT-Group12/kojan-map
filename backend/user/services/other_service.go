...
func (bas *BusinessApplicationService) CreateBusinessApplication(userID, businessName, kanaBusinessName, zipCode, address, phone string) error {
	if userID == "" || businessName == "" || kanaBusinessName == "" || address == "" || zipCode == "" || phone == "" {
