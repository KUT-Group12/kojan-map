...
describe('AdminUserManagement', () => {
    ...
    it('ユーザー一覧が表示される', () => {
        ...
        // 投稿数や登録日も表示
        expect(screen.getByText(/投稿数: 5/)).toBeInTheDocument();
        expect(screen.getByText(/登録日: 2026-01-02/)).toBeInTheDocument();
    });
    ...
    it('削除ボタンをクリックすると confirm が表示され OK なら onDeleteAccount が呼ばれる', () => {
        ...
        expect(confirmSpy).toHaveBeenCalledWith('山田 太郎 さんのアカウントを削除してもよろしいですか？');
