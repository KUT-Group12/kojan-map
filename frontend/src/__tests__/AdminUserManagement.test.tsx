...
describe('AdminUserManagement', () => {
    ...
    it('ユーザー一覧が表示される', () => {
        ...
        // 山田 太郎 (一般) の確認
        const user1Card = screen.getByText('山田 太郎').closest('.border-slate-200.rounded-lg') as HTMLElement;
        ...
        // 事業者A の確認
        const user2Card = screen.getByText('事業者A').closest('.border-slate-200.rounded-lg') as HTMLElement;
        ...
        // 管理者B の確認
        const user3Card = screen.getByText('管理者B').closest('.border-slate-200.rounded-lg') as HTMLElement;
