...
export function UserReactionViewScreen({ reactedPosts, userNameMap, onPostClick }: UserReactionViewScreenProps) {
  ...
  return (
    <div className="grid gap-4">
      {reactedPosts.map((post) => {
        ...
        const color = genreColors[genreKey];
        const label = genreLabels[genreKey];
